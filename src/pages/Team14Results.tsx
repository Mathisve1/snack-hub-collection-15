...
import { 
  useTeam14BuyingPersonas, 
  useTeam14Frituren, 
  useTeam14StreetInterviews 
} from "@/features/team-data/hooks/useTeam14Data";
import { useState } from "react";
import { toast } from "sonner";
import Team14BuyingPersonasTable from "@/features/team-data/components/Team13BuyingPersonasTable";
import Team14BuyingPersonasCards from "@/features/team-data/components/Team13BuyingPersonasCards";
import Team14FriturenTable from "@/features/team-data/components/Team13FriturenTable";
import Team14StreetInterviewsTable from "@/features/team-data/components/Team13StreetInterviewsTable";

const Team14Results = () => {
  const navigate = useNavigate();
  const { data: personas, loading: personasLoading, error: personasError } = useTeam14BuyingPersonas();
  const { data: frituren, loading: friturenLoading, error: friturenError } = useTeam14Frituren();
  const { data: interviews, loading: interviewsLoading, error: interviewsError } = useTeam14StreetInterviews();
  ...
  console.log("Team14Results page - data stats:", {
  ...
  return (
    <>
      <Helmet>
        <title>Team 14 Research Results | Snack Innovation</title>
      </Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
          <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-semibold">Team 14 Research Results</h1>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="bg-white rounded-lg shadow">
            <div className="p-6">
              <h2 className="text-2xl font-bold mb-6">Team 14 Market Research Data</h2>
              
              <p className="text-gray-600 mb-8">
                This page presents the complete market research findings from Team 14's research on 
              ...
              {isLoading ? (
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-md p-6 text-center">
                  ...
                  <p className="text-blue-700 mb-4">
                    There appears to be no data in the Team 14 tables. Please check the Supabase database 
                  ...
                  <div className="bg-white rounded p-4 text-left max-w-lg mx-auto border border-blue-100">
                    ...
                    <ul className="list-disc pl-5 text-sm text-blue-600">
                      <li><code>Team14buyingpersonasforwebsite</code></li>
                      <li><code>Team14friturenforwebsite</code></li>
                      <li><code>Team14streetinterviewsforwebsite</code></li>
                    </ul>
                  </div>
                </div>
              ) : (
                <Tabs defaultValue="buyingPersonas" className="w-full">
                  ...
                  <TabsContent value="buyingPersonas">
                    ...
                    {personasViewMode === "table" ? (
                      <Team14BuyingPersonasTable personas={personas} />
                    ) : (
                      <Team14BuyingPersonasCards personas={personas} />
                    )}
                  </TabsContent>
                  
                  <TabsContent value="frituren">
                    <Team14FriturenTable frituren={frituren} />
                  </TabsContent>
                  
                  <TabsContent value="streetInterviews">
                    <Team14StreetInterviewsTable interviews={interviews} />
                  </TabsContent>
                </Tabs>
              )}
            </div>
