...
export function useTeam14BuyingPersonas() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setLoading(true);
        console.log("Fetching Team 14 buying personas data...");
        
        const tableName = "Team14buyingpersonasforwebsite";
        ...
        console.error("Error fetching Team 14 buying personas:", err);
        setError(err instanceof Error ? err.message : "Unknown error");
        toast.error(`Error loading Team 14 buying personas: ${err instanceof Error ? err.message : "Unknown error"}`);
      } finally {
        setLoading(false);
      }
    }
...
export function useTeam14Frituren() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setLoading(true);
        console.log("Fetching Team 14 frituren data...");
        
        const tableName = "Team14friturenforwebsite";
        ...
        console.error("Error fetching Team 14 frituren data:", err);
        setError(err instanceof Error ? err.message : "Unknown error");
        toast.error(`Error loading Team 14 frituren data: ${err instanceof Error ? err.message : "Unknown error"}`);
      } finally {
        setLoading(false);
      }
    }
...
export function useTeam14StreetInterviews() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setLoading(true);
        console.log("Fetching Team 14 street interviews data...");
        
        const tableName = "Team14streetinterviewsforwebsite";
        ...
        console.error("Error fetching Team 14 street interviews:", err);
        setError(err instanceof Error ? err.message : "Unknown error");
        toast.error(`Error loading Team 14 street interviews: ${err instanceof Error ? err.message : "Unknown error"}`);
      } finally {
        setLoading(false);
      }
    }
